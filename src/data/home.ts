export const homeContent = {
  ...
  focusAreas: [
    {
      title: 'IT Governance',
      description: 'Technology oversight, accountability, policy and decision structures.',
    },
    {
      title: 'Technology Risk & Controls',
      description: 'Risk assessment, control design, remediation and monitoring.',
    },
    {
      title: 'Assurance & Compliance',
      description: 'Audit readiness, regulatory assurance, PCI DSS and ISO 27001.',
    },
  ],
  career: {
